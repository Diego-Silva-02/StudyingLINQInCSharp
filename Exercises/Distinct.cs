...
namespace Exercises
{
    public static class Distinct
    {
        ...
        {
            return collections
                    .OrderBy(collection => collection.Count() - collection.Distinct().Count()) // Order by the list with more duplicates
                    .ThenByDescending(collection => collection.Count()) // Order by Descending the list with more values
                    .LastOrDefault();
        }
